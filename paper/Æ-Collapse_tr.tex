...
\title{Æ-Collapse: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Æ-Collapse'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
